...
namespace MernisKimlik
{
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tckimlik.nvi.gov.tr/WS", ConfigurationName="MernisKimlik.KPSPublicSoap")]
    public interface KPSPublicSoap
    {
        ...
        MernisKimlik.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(MernisKimlik.TCKimlikNoDogrulaRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<MernisKimlik.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(MernisKimlik.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest
    {
        ...
        public MernisKimlik.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest()
        {
        }
        
        public TCKimlikNoDogrulaRequest(MernisKimlik.TCKimlikNoDogrulaRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse
    {
        ...
        public MernisKimlik.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse()
        {
        }
        
        public TCKimlikNoDogrulaResponse(MernisKimlik.TCKimlikNoDogrulaResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface KPSPublicSoapChannel : MernisKimlik.KPSPublicSoap, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<MernisKimlik.KPSPublicSoap>, MernisKimlik.KPSPublicSoap
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        MernisKimlik.TCKimlikNoDogrulaResponse MernisKimlik.KPSPublicSoap.TCKimlikNoDogrula(MernisKimlik.TCKimlikNoDogrulaRequest request)
        {
        ...
        {
            MernisKimlik.TCKimlikNoDogrulaRequest inValue = new MernisKimlik.TCKimlikNoDogrulaRequest();
            inValue.Body = new MernisKimlik.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            inValue.Body.Ad = Ad;
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            MernisKimlik.TCKimlikNoDogrulaResponse retVal = ((MernisKimlik.KPSPublicSoap)(this)).TCKimlikNoDogrula(inValue);
            return retVal.Body.TCKimlikNoDogrulaResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<MernisKimlik.TCKimlikNoDogrulaResponse> MernisKimlik.KPSPublicSoap.TCKimlikNoDogrulaAsync(MernisKimlik.TCKimlikNoDogrulaRequest request)
        {
            return base.Channel.TCKimlikNoDogrulaAsync(request);
        }
        
        public System.Threading.Tasks.Task<MernisKimlik.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(long TCKimlikNo, string Ad, string Soyad, int DogumYili)
        {
            MernisKimlik.TCKimlikNoDogrulaRequest inValue = new MernisKimlik.TCKimlikNoDogrulaRequest();
            inValue.Body = new MernisKimlik.TCKimlikNoDogrulaRequestBody();
            inValue.Body.TCKimlikNo = TCKimlikNo;
            ...
            inValue.Body.Soyad = Soyad;
            inValue.Body.DogumYili = DogumYili;
            return ((MernisKimlik.KPSPublicSoap)(this)).TCKimlikNoDogrulaAsync(inValue);
        }
